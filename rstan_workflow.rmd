...
This is a collection of regressions done in Rstan. Regression is the bread and butter of statistical analysis and Bayesian regression is superior due to the use of constraining priors and the generative ability of the model. Due to the Hamiltonian Monte Carlo algorithm, Stan is arguably the best way to do Bayesian regression. 
